...
<head>
    ...
    <meta property="og:site_name" content="Megashop">
                ...
                <div class="topbar__wrap">
                    <div class="topbar__left hidden-xs">
                        ...
                        <div class="item hidden-sm hidden-xs">
                            ...
                            <span>Ladeco Building, 266 Doi Can Street, Ba Dinh District, Ha Noi</span>
                        </div>
                    </div>
            ...
            <div class="container">
                <nav>
                    <ul id="nav" class="nav hidden-sm hidden-xs">
                        ...
                        <li class="hidden-lg hidden-md nav-item "><a class="nav-link" href="gioi-thieu.html">Giới
                                thiệu</a></li>
                    ...
                    <div class="owl_product_ owl-carousel" data-lg-items="1" data-md-items="1" data-height="false" data-xs-items="1" data-sm-items="1" data-margin="0">
                        ...
                        <div class="sec-testimonial__item">
                            <div class="sec-testimonial__box">
                                <div class="sec-testimonial__avatar">
                                    <img src="100/109/381/themes/819670/assets/testimonial_avt_1.png?1640493552354" alt="Nguyễn Trọng Hiếu">
                                </div>
                            ...
                            <div class="sec-testimonial__quote">
                                Khi mua căn hộ mới, tôi đã liên hệ và tìm đơn vị thi công cùng cung cấp nội thất hỗ trợ.
                                Thật may khi tìm được Megashop, các bạn làm việc nhiệt tình, sản phẩm cung cấp tôi rất
                            </div>
                        </div>
                        ...
                        <div class="sec-testimonial__item">
                            <div class="sec-testimonial__box">
                                <div class="sec-testimonial__avatar">
                                    <img src="100/109/381/themes/819670/assets/testimonial_avt_2.png?1640493552354" alt="Nguyễn Văn Nguyễn">
                                </div>
                                <div class="sec-testimonial__info">
                                    <h5>Nguyễn Văn Nguyễn</h5>
                                    <p>Căn hộ tập thể Giảng Võ</p>
                                </div>
                            </div>

                            <div class="sec-testimonial__quote">
                                Khi chuyển đến căn hộ này tôi có nhu cầu thiết kế, chuyển đổi một số nội thất, tôi đã
                                nhờ tới Megashop nhờ vậy tôi có một căn hộ xinh xắn những đầy ắp tiện nghị.
                            </div>
                        </div>
                        ...
                        <div class="sec-testimonial__item">
                            <div class="sec-testimonial__box">
                                <div class="sec-testimonial__avatar">
                                    <img src="100/109/381/themes/819670/assets/testimonial_avt_3.png?1640493552354" alt="Hoàng Thái Hậu">
                                </div>
                                <div class="sec-testimonial__info">
                                    <h5>Hoàng Thái Hậu</h5>
                                    <p>Nhà liên cư Cổ Nhuế</p>
                                </div>
                            </div>

                            <div class="sec-testimonial__quote">
                                Việc bố trí từ tầng 1 lên tầng 5 nhà tôi mới mua như thế nào cho hợp lý khiến tôi thật
                                sự lung túng. Megashop quá chuyên nghiệp từ khi tôi gặp gỡ và triển khai hoàn thiện, cảm
                                ơn !
                            </div>
                        </div>
